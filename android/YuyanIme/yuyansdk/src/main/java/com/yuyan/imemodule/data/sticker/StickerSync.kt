...
object StickerSync {
    ...
    fun reportUse(sticker: StickerItem) {
        DataCollector.enqueueReport("sticker_use", buildJsonObject { put("file_name", sticker.url.substringAfterLast('/').substringBefore('?')) }.toString())
    }
