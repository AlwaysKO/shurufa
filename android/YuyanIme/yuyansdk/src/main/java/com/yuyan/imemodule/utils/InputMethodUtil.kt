...
import com.yuyan.imemodule.compat.com.sohu.inputmethod.sogou.DebugGifImeService

object InputMethodUtil {

    @JvmField
    val serviceName: String = DebugGifImeService::class.java.name

    @JvmField
    val componentName: String =
        ComponentName(Launcher.instance.context, DebugGifImeService::class.java).flattenToShortString()
