...
class KeyboardToolbarModelTest {
    ...
    fun `工具栏使用1080参考图的图标画布和七个总槽位`() {
        ...
        assertEquals(78, KeyboardToolbarMetrics.functionIconSize(1080, 200))
        assertEquals(67, KeyboardToolbarMetrics.functionIconSize(1080, 97))
        assertEquals(78, KeyboardToolbarMetrics.collapseIconSize(1080, 200))
    }
}
